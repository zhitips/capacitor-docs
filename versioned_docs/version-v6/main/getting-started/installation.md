...
`npx cap sync` will copy your built web bundle expected to be found in `webDir` of the [Capacitor Config](/config) file to your native project and install the native project's dependencies.
